...
const dataSource2 = [
  ...
  {  
    title: "联合GWAS与3D基因组技术解析东南亚地方猪杂种后代生长性能的基因组调控机制",
    number: "31961143020",
    person: "朱猛进",
    money: "155",
    date: "2020/1/1",
...
const dataSource3 = [
  ...
  {  
    title: "猪伪狂犬病、猪瘟区域净化与根除及种猪场高致病性蓝耳病净化技术集成与示范",
...
<template>
  <div class="wrap">
    <SwiperPage>
      <swiper-slide>
        <a-table :columns="column1" :data-source="dataSource1"></a-table>
      </swiper-slide>
      <swiper-slide>
        <a-table :columns="column1" :data-source="dataSource2"></a-table>
      </swiper-slide>
      <swiper-slide> 
        <a-table :columns="column1" :data-source="dataSource3"></a-table>

      </swiper-slide>
      <swiper-slide> 
        <a-table :columns="column1" :data-source="dataSource4"></a-table>
      </swiper-slide>
    </SwiperPage>
  </div>
</template>
